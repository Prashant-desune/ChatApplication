import java.io.*;// For input output of the message 
import java.net.*;// Because we are Using Networking 
...
public class Server extends JFrame{
    ...
    private void createGUI(){
        ...
        heading.setIcon(new ImageIcon("./icon1.gif"));
...
// we use the concept of multithreading in the methods 
    ...
    public static void main(String[] args) {
        System.out.println("This is Server Side . going to start ");
        new Server(); //Call the constructor using new Keyword 
